...
go_repository(
    ...
    sum = "h1:OAR/GtjMOhenkp1NNKr1N1FgIP3mQXHeGbRhvVIAQp0=",
    version = "v1.20.20",
)
...
go_repository(
    name = "com_github_pocockn_awswrappers",
    importpath = "github.com/pocockn/awswrappers",
    sum = "h1:bBMWjRRC8MG1eoSsmjV0Cj01Rz2chikjnGo+8pftyFw=",
    version = "v0.0.0-20190604072748-a1628bbacc94",
)

go_repository(
    name = "com_github_pocockn_database_migrator",
    importpath = "github.com/pocockn/database-migrator",
    sum = "h1:z/qv0N8I0jIijQBYfHJRJwRAX1pn47Yz7YvK0of5iNA=",
    version = "v0.13.0",
)

go_repository(
    name = "com_github_pocockn_models",
    importpath = "github.com/pocockn/models",
    sum = "h1:Zwrxo0WaU1dBNu/MUz78pM941Tn2R/je0xvwusVfxtc=",
    version = "v0.8.0",
)

go_repository(
    name = "com_github_pocockn_recs_api",
    importpath = "github.com/pocockn/recs-api",
    sum = "h1:IcL2ZnXxW71JU7qbG1cwLfmwrw2euh6JrAHf76fm208=",
    version = "v0.1.0",
)

go_repository(
    name = "com_github_pocockn_spotify_poller",
    importpath = "github.com/pocockn/spotify-poller",
    sum = "h1:CQWG3DscUWi+i9yb26L+iRX/WIffRIdpma0/yvbMLwc=",
    version = "v0.1.1",
)
...
go_repository(
    ...
    sum = "h1:hNpmUdy/+ZXYpGy0OBfm7K0UQTzb73W0T0U4iJIVrMw=",
    version = "v1.9.0",
)
...
go_repository(
    name = "com_github_vidsy_awswrappers",
    importpath = "github.com/vidsy/awswrappers",
    sum = "h1:9QM4+jxvn79G5NqzU2jX7LoVa1y2CsDJQG6aLZNNeUY=",
    version = "v0.0.0-20190425100525-100bf35831ff",
)

go_repository(
    name = "com_github_vidsy_go_kmsconfig",
    importpath = "github.com/vidsy/go-kmsconfig",
    sum = "h1:XzUOcVH/fcyrN5SSeKS/P7TCxVWprJBEjPamm5k4iwk=",
    version = "v0.0.0-20190205094205-1627843c4cce",
)
...
go_repository(
    name = "com_github_zmb3_spotify",
    importpath = "github.com/zmb3/spotify",
    sum = "h1:fSnEhxQWMrRxwyfQzMVEi8tBFHR7YCdREwbSVhHTHpE=",
    version = "v0.0.0-20200331200324-6a9312f5d1de",
)
...
go_repository(
    name = "in_gopkg_gormigrate_v1",
    importpath = "gopkg.in/gormigrate.v1",
    sum = "h1:XpYM6RHQPmzwY7Uyu+t+xxMXc86JYFJn4nEc9HzQjsI=",
    version = "v1.6.0",
)
